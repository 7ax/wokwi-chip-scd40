...
// Source: https://github.com/wokwi/inverter-chip (MIT License)
...
__attribute__((unused)) static void timer_start_ns(const timer_t timer, uint64_t nanos, bool repeat) {
...
__attribute__((unused)) static uint64_t get_sim_nanos(void) {
